...
module.exports = class LavaPacketCollector {
  ...
  async lavaPacketSignatureBurned(packetData,env){
        ...
        var params = lavaPacketUtils.getLavaParamsFromData(packetData.method,packetData.from,packetData.to,packetData.walletAddress,packetData.tokenAddress,packetData.tokenAmount,packetData.relayerReward,packetData.expires,packetData.nonce)
