...
module.exports = class LavaPacketCollector {
  ...
  async storeNewLavaPacket(packetData)
  {
    ...
    if( !this.lavaPacketHasValidSignature( packetData ) )
    {
      return {success:false}
    }

    if( this.lavaPacketSignatureBurned( packetData )   )
    {
      return {success:false}
    }
  ...
  //  var recoveredSignatureSigner = ECRecovery.recover(sigHash,packetData.signature);
    ...
    console.log('recoveredSignatureSigner',recoveredSignatureSigner,packetData.from)
  ...
  async lavaPacketSignatureBurned(packetData){

    var burned = await ContractInterface.getWalletContract(web3,'test').signatureBurned.call('0x8e527391a81f77244bf95df58737eecac386ab9a47acd21bdb63757adf71ddf878169c18e4ab7b71d60f333c870258a0644ac7ade789d59c53b0ab75dbcc87d11b')
