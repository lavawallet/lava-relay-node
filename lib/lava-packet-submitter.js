...
module.exports = class LavaPacketSubmitter  {
  ...
  async broadcastLavaPacket(packetData,broadcastingSpeed)
  {
    ...
    var lavaContract = ContractInterface.getLavaContract(this.web3,this.relayConfig.environment);
    ...
    var lavaTransferMethod = lavaPacketUtils.getContractExecutionMethod(lavaContract,packetData)
