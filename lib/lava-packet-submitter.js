...
module.exports = class LavaPacketSubmitter  {
                  ...
                  //await this.redisInterface.deleteHashInRedis('queued_tx',signature)
                   ...
                   try{
                      ...
                      if(broadcastingSpeed == 'fast')
                      {
                       ...
                       var txHash = await self.broadcastLavaPacket(packetData,broadcastingSpeed,relayingGasPrice,this.getRelayAccount(),this.web3,this.relayConfig.environment);
  ...
  static async broadcastLavaPacket(packetData,broadcastingSpeed,relayingGasPrice,relayAccount,web3,env)
  {
    ...
    console.log('meep method',lavaTransferMethod)
    ...
    //  var privKey = this.truncate0xFromString( pKey )
