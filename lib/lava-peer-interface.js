...
module.exports = class LavaPeerInterface  {
  ...
  async collectPeriodicData()
  {
    ...
    try{
      ...
      this.redisInterface.storeRedisData('ethGasNormal', (gasData.normal / 10.0 ) ) //gwei
      this.redisInterface.storeRedisData('ethGasNormalWait', gasData.normalWait )
  ...
  */
  ...
  async getRelayData()
  {
    var relayData = {};
     ...
     relayData.targetFastRewardTokens = parseFloat( await this.getTargetRewardTokens('ethGaFast') ).toFixed(3)
