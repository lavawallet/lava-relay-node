...
module.exports = class LavaPeerInterface  {
  ...
  */
  ...
  async getTargetFastRewardTokens()
  {
    ...
    var ethGasFastGwei = await this.redisInterface.loadRedisData('ethGasFast'  ) ;

    var ethGasFastEth = ethGasFastGwei / (Math.pow(10,9))


    var requiredEthForTXRelay = _GAS_REQUIRED_FOR_TX_RELAY * ethGasFastEth;
  ...
  async getRelayData()
  {
    var relayData = {};
     ...
     relayData.targetFastRewardTokens = parseFloat( await this.getTargetFastRewardTokens() ).toFixed(3)
