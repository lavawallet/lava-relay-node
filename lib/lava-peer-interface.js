          ...
          if(activePeersResult == null )
          {
            couldConnect = false;
             ...
             console.log('got a new list of active peers:', activePeersResult )
              ...
              for(var i in activePeersResult)
              {
                var newPeer = activePeersResult[i];
                  await handleNewSharedPeer(newPeer);
              }
    ...
    var self = this;
     ...
     var server = jayson.server({
       ...
       getNodeActivePeers: async function(args, callback) {
           ...
           callback(null,   {'activePeers': JSON.stringify(activePeers )  }    );
       ...
       giveSelfPeerData: async function(args, callback) {
           ...
           await handleNewSharedPeer(newPeerData);
